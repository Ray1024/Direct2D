...
private:
	...
	ID2D1StrokeStyle*		m_pStrokeStyle1;	// 线型1
	ID2D1StrokeStyle*		m_pStrokeStyle2;	// 线型2
	ID2D1StrokeStyle*		m_pStrokeStyle3;	// 线型3
	ID2D1StrokeStyle*		m_pStrokeStyle4;	// 线型4
	ID2D1StrokeStyle*		m_pStrokeStyle5;	// 线型5
	ID2D1StrokeStyle*		m_pStrokeStyle6;	// 线型5
};
