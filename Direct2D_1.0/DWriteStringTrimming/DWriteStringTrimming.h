...
private:
	...
	ID2D1SolidColorBrush*	m_pFontBrush;		// 文字画刷
	ID2D1SolidColorBrush*	m_pRectBrush;		// 矩形框画刷
	IDWriteTextFormat*		m_pTF1;				// 格式1
	IDWriteTextFormat*		m_pTF2;				// 格式2
	IDWriteTextFormat*		m_pTF3;				// 格式3
	IDWriteTextFormat*		m_pTF4;				// 格式4
	IDWriteTextFormat*		m_pTF5;				// 格式5
};
