...
private:
	...
	ID2D1EllipseGeometry*				m_pCircle;			// 圆形
	ID2D1RoundedRectangleGeometry*		m_pRoundedRectangle;	// 圆角矩形
	ID2D1PathGeometry*					m_pTriangle;		// 三角形
	ID2D1PathGeometry*					m_pPentagram;		// 五角星
};
